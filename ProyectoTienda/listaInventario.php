...
<html>
    ...
    <body>
        ...
        <div class="c1">
            ...
            <?php
                //Realizamos la consulta para recuperar la informacion de los productos que hay
                ...
                <table id="Lista" class="table table-sm">
                    <thead id="encabezadoLista">
                        <tr>
                            ...
                            <th scope="col">Precio de comprar</th>
                    ...
                    <tbody id="cuerpoLista">
                        <?php
                            ...
                            while($columna = mysqli_fetch_array($resultado)){
                                ...
                                echo "<tr>";
                                echo "<td>" . $columna['nombreProducto'] . "</td><td>" . $columna['descripcion'] . "</td><td>" . $columna['precioCompra'] . "</td><td>" . $columna['precioVenta'] . "</td><td>" . $columna['pesoOunidad'] . "</td><td>" . $columna['cantidad'] . "</td><td>" . $columna['nombreCategoria'] . "</td><td>" . $columna['nombreProveedor'] . "</td>";
                        ?>
                        <td>
                            <form action="../modificarProducto.php" method="post" id="infoModificar">
                                <input type="hidden" name="id" value="<?php echo $columna['idProducto']; ?>">
