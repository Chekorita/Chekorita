...
<html>
    ...
    <body>
        ...
        <div class="c1">
            ...
            <?php
                //Realizamos la consulta para recuperar la informacion de los usuarios que hay
                    ...
                    <tbody id="cuerpoLista">
                        <?php
                            ...
                            while($columna = mysqli_fetch_array($resultado)){
                                ...
                                echo "<tr>";
                                echo "<td>" . $columna['nombreUsuario'] . "</td><td>" . $columna['apellidosUsuario'] . "</td><td>" . $columna['username'] . "</td><td>" . $columna['email'] . "</td><td>" . $columna['telefono'] . "</td><td>" . $columna['direccion'] . "</td><td>" . $columna['tipo'] . "</td>";
                        ?>
                        <td>
                            <form action="../modificarUsuario.php" method="post" id="infoModificar">
                                <input type="hidden" name="id" value="<?php echo $columna['idUsuario']; ?>">
